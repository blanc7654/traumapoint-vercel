const TMAP_HARDCODED_KEY = "tEiRteq9K69x8eOSBcOJb3FWVFkzNRiJ3OxUBB1m";

export async function getTmapRoute(origin, destination, apiKey = TMAP_HARDCODED_KEY, departureTime = new Date()) {
